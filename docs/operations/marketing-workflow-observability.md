...
| `workflow.action.retry.scheduled` | `warn` | `uid`, `taskId`, `failureKind`, `errorCode`, `diagnosticMessage`, `retryAt` |
| `workflow.action.failed` | `warn` | `uid`, `taskId`, `failureKind`, `errorCode`, `diagnosticMessage` |
