...
- `draft-ready`：无
- `runtime-ready`：`start`、`wait`、`wait-event`、`branch`、`ratio-split`、`message`、`message-query`、`handoff`、`tag-query`、`tag`、`customer-update`、`order-bind`、`order-query`、`order-conversion`、`coupon`、`llm`、`ai-intent`、`ai-collect`、`end`
- `placeholder`：`agent`
