...
- `runtime-ready`：`start`、`wait`、`wait-event`、`branch`、`ratio-split`、`message`、`message-query`、`handoff`、`tag-query`、`tag`、`customer-update`、`order-bind`、`points-transfer`、`llm`、`ai-intent`、`end`
