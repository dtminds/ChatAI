...
describe("formatTextMessageSentAt", () => {
  ...
  it("formats same-year timestamps without year or seconds, padding minutes only", () => {
    expect(formatTextMessageSentAt("2026-06-11 13:22:45", now)).toBe("6/11 13:22");
    expect(formatTextMessageSentAt("2026-05-08 09:54:00", now)).toBe("5/8 9:54");
  ...
  it("includes the year for timestamps outside the current year", () => {
    expect(formatTextMessageSentAt("2025-12-31 09:08:07", now)).toBe("2025/12/31 9:08");
  });
