            ...
            <PlainTextPlugin
              contentEditable={
                <ContentEditable
                  ...
                  aria-multiline="true"
                  className="chat-composer-textarea -mr-3 min-h-18 max-h-80 overflow-y-auto rounded-none border-0 bg-transparent py-1 pl-0 pr-3.5 text-[14px] leading-6 shadow-none outline-none focus-visible:ring-0"
