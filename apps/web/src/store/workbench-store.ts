  ...
  return create<WorkbenchStore>((set, get) => {
    ...
    async function loadConversationAfterDelete(
      ...
      try {
        ...
        const pageSmartReplyActiveMessageKey: string | undefined = undefined;
    ...
    async initializeWorkbench(options) {
      ...
      try {
        ...
        const prunedConversationListCache = pruneConversationListCache({
          ...
          const bootstrapSmartReplyActiveMessageKey: string | undefined = undefined;
    ...
    async setActiveAccount(accountId) {
      ...
      try {
        ...
        const accountSwitchSmartReplyActiveMessageKey: string | undefined = undefined;
